...
const MEDICINE_GAME_DATA = [
    {
        id: 1,
        progress: "1/4",
        question: "איזו תרופה ניתן להנפיק רק לאחר אישור של ענף שר״פ?",
        correctAnswer: "asmachta",
        successText: "נכון מאוד!",
        wrongAnswers: {
            teken15d:
                "טעות! תרופות תקן 15ד נמצאות בסמכות הרישום והניפוק של חובש ואינן דורשות אישור ענף שר״פ.",

            teken15:
                "טעות! תרופות תקן 15 נרשמות על ידי רופא יחידה ויכולות להיות מנופקות על ידי חובש או רוקח.",

            mumhim:
                "טעות! תרופות מומחים נרשמות על ידי רופא מומחה ומנופקות על ידי רוקח."
        }
    },

    {
        id: 2,
        progress: "2/4",
        question: "איזו תרופה נרשמת על ידי רופא מומחה ומנופקת בבית המרקחת על ידי רוקח?",
        correctAnswer: "mumhim",
        successText: "נכון מאוד!",
        wrongAnswers: {
            teken15d:
                "טעות! תרופות תקן 15ד נרשמות ומנופקות על ידי חובש במרפאת היחידה.",

            teken15:
                "טעות! תרופות תקן 15 נרשמות על ידי רופא יחידה ויכולות להיות מנופקות על ידי חובש או רוקח.",

            asmachta:
                "טעות! תרופות באסמכתא תקציבית מחייבות אישור של ענף שר״פ."
        }
    },

    {
        id: 3,
        progress: "3/4",
        question: "לאיזו קבוצת תרופות יש לחובש סמכות לרשום את המרשם?",
        correctAnswer: "teken15d",
        successText: "נכון מאוד!",
        wrongAnswers: {
            teken15:
                "טעות! תרופות תקן 15 נרשמות על ידי רופא יחידה.",

            mumhim:
                "טעות! תרופות מומחים נרשמות על ידי רופא מומחה בלבד.",

            asmachta:
                "טעות! אסמכתא תקציבית היא אישור לתרופות חריגות ואינה סמכות רישום של חובש."
        }
    },

    {
        id: 4,
        progress: "4/4",
        question: "איזו קבוצת תרופות נרשמת על ידי רופא יחידה וניתנת להנפקה על ידי חובש או רוקח?",
        correctAnswer: "teken15",
        successText: "נכון מאוד!",
        wrongAnswers: {
            teken15d:
                "טעות! גם תרופות תקן 15ד יכולות להיות מנופקות על ידי חובש או רוקח, אך סמכות הרישום שלהן היא של חובש ולא של רופא יחידה.",

            mumhim:
                "טעות! תרופות מומחים נרשמות על ידי רופא מומחה ומנופקות על ידי רוקח בלבד.",

            asmachta:
                "טעות! תרופות באסמכתא תקציבית דורשות אישור ענף שר״פ ואינן מוגדרות לפי סמכות הרישום של רופא יחידה."
        }
    }
];
